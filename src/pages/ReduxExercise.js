...
import { removeCart } from "../service/cart/slice";
...
const ProductOne = (props) => {
  ...
  // Make the function handle onClick event of the button
  const handlClickRemoveFromCart = () => {
        ...
        <Grid item xs={8}>
          <div style={{ display: "flex", justifyContent: "space-around" }}>
            ...
            <Button
              variant="error"
              sx={{ width: "5rem" }}
              onClick={handlClickRemoveFromCart}
            >
              Remove
            </Button>
          </div>
